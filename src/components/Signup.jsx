...
const Signup = () => {
  return (
    <>
        ...
        <form className="form flex flex-col gap-4 bg-white p-8 w-full max-w-md rounded-2xl font-sans">
      <div className="flex flex-col">
        ...
        <div className="inputForm flex items-center px-3 border border-gray-200 rounded-lg h-12 transition-colors duration-200">
          ...
          <input type="text" className="input ml-3 w-full h-full border-none focus:outline-none" placeholder="Enter your Email" />
        </div>
      </div>
      ...
      <div className="flex flex-col">
        ...
        <div className="inputForm flex items-center px-3 border border-gray-200 rounded-lg h-12 transition-colors duration-200">
          ...
          <input type="password" className="input ml-3 w-full h-full border-none focus:outline-none" placeholder="Enter your Password" />
        </div>
      </div>
      ...
      <div className="flex flex-col">
        ...
        <div className="inputForm flex items-center px-3 border border-gray-200 rounded-lg h-12 transition-colors duration-200">
          ...
          <input type="password" className="input ml-3 w-full h-full border-none focus:outline-none" placeholder="Confirm your Password" />
        </div>
      </div>
      ...
      <div className="flex flex-col gap-3">
        <button className="btn flex justify-center items-center gap-2 border border-gray-200 rounded-lg h-12 w-full hover:border-blue-500 transition-colors duration-200">
          <svg className="w-5 h-5" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path
              fill="#FBBB00"
        ...
        <button className="btn flex justify-center items-center gap-2 border border-gray-200 rounded-lg h-12 w-full hover:border-blue-500 transition-colors duration-200">
          <svg className="w-5 h-5" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.773 22.773">
            <g>
              <g>
