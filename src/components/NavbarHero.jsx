    ...
    <>
      ...
      <header className="absolute top-5 left-5 right-5 flex justify-between items-center w-11/12">
        ...
        <nav className="flex gap-5">
          <a href="" className="text-black text-lg">Products</a>
          <a href="" className="text-black text-lg">Research</a>
          <a href="" className="text-black text-lg">Company</a>
          <a href="" className="text-black text-lg">Docs</a>
        </nav>
        <div className='flex justify-center gap-8'>
          <button className="login bg-[#353535] px-9 py-4 text-white rounded-xl text-lg">Login</button>
          <button className="signup rounded-xl border border-[#353535] px-8 py-1 hover:bg-black hover:text-white transition ease-in delay-200 text-lg">Sign Up</button>
        </div>
      </header>
